package com.zh.framework.aspectj;
...
import com.zh.framework.aspectj.lang.enums.BusinessStatus;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.zh.framework.aspectj.lang.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            // 返回参数
            if(controllerLog.businessType() != BusinessType.SELECT){
