    ...
    $.extend({
        ...
        modal: {
            ...
            openOptions: function (options) {
                ...
                var _anim = $.common.isEmpty(options.anim)? 0 : options.anim;
            ...
            // 选卡页方式打开   ifIndex代表是否在index.html打开
            openTab: function (title, url, ifIndex) {
                createMenuItem(url, title,ifIndex);
            },
            // 选卡页同一页签打开
